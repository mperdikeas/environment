# provenance: https://gist.github.com/nolanlawson/8694399
# I effected two changes:
#  (a) added the stripcolorcodes filter in ln. 37
#  (b) invoked complete on the 'g' alias on ln. 44
_gradle()
{
