declare -a repos=("tools" "java-mutil" "environment" "ocaml-mutil" "playground"
                  ...
                  "archetype-ts-node-playground" "archetype-ts-antd-playground" "cognitera-iacs/ts-react-iacs" "sscce-typescript-react-eslint"
                  "playground-ts-node-promises" "antd-form-list-sscce" "openlayers-playground"
                 )
